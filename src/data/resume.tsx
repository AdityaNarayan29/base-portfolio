...
,
  ...
  projects: [
    ...
    active: false,
    description:
      "Gratt is a productivity and task-tracking web app. It features GitHub API integration for developers, JWT-based secure login, a Kanban task view, and is deployed using AWS EC2 and Route 53. Built with the MERN stack, Gratt was designed for personal organization and team collaboration.",
    technologies: [
      "React.js",
      "Redux",
      "Node.js",
    ...
    links: [
      {
        type: "GitHub",
        href: "https://github.com/AdityaNarayan29/gratt",
        icon: <Icons.github className="size-3" />,
      },
    ],
    image: "",
  ...
  },  
  {
    ...
    active: false,
    description:
      "MediaPlayer++ is a feature-rich Chrome extension that enhances video playback experience. It includes custom playback controls, ad skipping, bookmarking, volume scroll, PiP mode, and theme customization. Built using WebExtension APIs with a Next.js base, it supports modern browser environments.",
    technologies: [
      "Next.js",
      "JavaScript",
      "WebExtensions",
    ...
    links: [
      {
        type: "GitHub",
        href: "https://github.com/AdityaNarayan29/media-player-extension",
        icon: <Icons.github className="size-3" />,
      },
    ],
    image: "",
