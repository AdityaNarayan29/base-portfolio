...
export const DATA = {
  ...
  projects: [
    ...
    {
      title: "Masst Dev",
      href: "https://www.masst.dev/",
      dates: "Dec 2024 - Present",
      active: true,
      description:
        "Masst.dev is a developer ecosystem bringing together a suite of tools — from AI-powered documentation and daily LeetCode tracking, to a modern UI library, CLI scaffolding tool, and event bus — designed to simplify learning, accelerate building, and streamline shipping for developers.",
      technologies: [
        "React",
        "TypeScript",
        "Next.js",
      ...
      links: [
        ...
        {
          type: "GitHub",
          href: "https://github.com/AdityaNarayan29/masstlanding",
          icon: <Icons.github className='size-3' />,
        },
      ],
      image: "",
